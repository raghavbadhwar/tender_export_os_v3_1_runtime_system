...
def run_supplier_engine(deep_read_cases, supplier_master, sources_supplier):
    ...
    Supplier quote/availability outreach requires explicit owner approval and
    receipts. Draft only until approval; keep buyer quote, PO, payment, DSC,
    bid upload, and final commitment gates intact.
    """
    ...
    for case in deep_read_cases:
        ...
        #     create_or_refresh_supplier_quote_request_approval_card(case, shortlist)
