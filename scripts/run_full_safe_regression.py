...
SAFE_COMMANDS = [
    ...
    ["scripts/capture_historical_gov_intelligence.py", "--dry-run", "--json"],
    ["scripts/gov_historical_intelligence.py", "--case-id", "GOV-20260630-001", "--json"],
    ["scripts/gov_supplier_532_gate.py", "--case-id", "GOV-20260630-001", "--allow-blocked", "--json"],
